...
public class Frm_Entrada extends javax.swing.JInternalFrame {
    ...
    private void guardar(){
        ...
        if(num == 0){
            int respuesta = CP.registrarEntrada(nfac,codigo,fecha_sql,cantidad,desc);
            if(respuesta > 0){
                listar();
                limpiar();
                iniciar();
    ...
    private void initComponents() {
        ...
        jbt_guardar.setFont(new java.awt.Font("Dubai Medium", 0, 14)); // NOI18N
        ...
        jLabel7.setFont(new java.awt.Font("Dubai Light", 2, 14)); // NOI18N
